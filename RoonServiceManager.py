...
class RoonServiceManager:
    ...
    @servicename.setter
    def set_servicename(self, value):
    ...
    def run(self):
        try:
            ...
            if not (settings is None):
                saveSettings()
    def connect(self, core_id, token):
        global logger
    ...
    def queue_change_callback(self, queuedata):
        global logger
        global roon
    ...
    def state_change_callback(self, event, changed_ids):
        global roon
    ...
    def volume_control_callback(self, control_key, event, value):
       pass
